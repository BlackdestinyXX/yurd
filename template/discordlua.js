const mainlua = `local discordia = require('discordia')
...
module.exports = {
	code: [{fileName: 'main.lua', fileCode: mainlua}],
    name: ['discord.lua', 'discordlua', 'discordia'],
    dependenciesCommand: 'lit install SinisterRectus/discordia',
}